...
import { Box, IconButton, TextField, Typography, Button, Paper } from "@mui/material";
      ...
      >
        ...
        >
          <Button
            ...
            onTouchEnd={stopHold}
          >
            <Paper elevation={10} sx={{ padding: { xs: 0.5, sm: 0.9 }, borderRadius: 2.5 }}>
          ...
          >
            <CheckIcon sx={{ fontSize: { xs: "1.15rem", sm: "1.25rem" } }} color="success" />
          </IconButton>
          <IconButton 
            size="small" 
            ...
            sx={{ padding: { xs: 0.6, sm: 1 } }}
          >
            <ClearIcon sx={{ fontSize: { xs: "1.15rem", sm: "1.25rem" } }} color="error" />
          </IconButton>
        </Box>
      </Box>
    );
